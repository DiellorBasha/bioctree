...
%
% Usage:
%   [V2, F2, log] = bct.manifold.repair.cleanForDEC(V, F);
%
% Outputs:
%   V2, F2 : repaired mesh
...
[Fw2, orientInfo] = bct.manifold.repair.orientConsistently(Vw, Fw);
...
if isWT
    [Fw3, outInfo] = bct.manifold.repair.orientOutward(Vw, Fw2);

function [vertices, label, colortable] = freesurfer_read_annotation_ctab(filename, varargin)
%
% NAME
%
%       function [vertices, label, colortable] = ...
%                                       freesurfer_read_annotation_ctab(filename [, verbosity])
%
% ARGUMENTS
% INPUT
...
%       
% EXAMPLE
% [vertices label ctab] = freesurfer_read_annotation_ctab(fname);
...
%
% freesurfer_read_annotation_ctab.m

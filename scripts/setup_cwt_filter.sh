...
# --- Config ---
ROOT="${1:-/mnt/c/CodingProjects/bioctree}"
TOOLBOX_DIR="$ROOT/toolbox"
FILTERS_DIR="$TOOLBOX_DIR/+bct/+filters"
EXAMPLES_DIR="$ROOT/examples"

echo "[bct] Using repo root: $ROOT"

# --- Ensure directories ---
mkdir -p "$FILTERS_DIR"
mkdir -p "$EXAMPLES_DIR"

# --- Write class: toolbox/+bct/+filters/CWT.m ---
cat > "$FILTERS_DIR/CWT.m" <<'MATLAB'
classdef CWT < handle
...
# --- Write example: examples/bct_cwt_filter_demo.m ---
cat > "$EXAMPLES_DIR/bct_cwt_filter_demo.m" <<'MATLAB'
...
echo "[bct] Wrote: $FILTERS_DIR/CWT.m"
echo "[bct] Wrote: $EXAMPLES_DIR/bct_cwt_filter_demo.m"
echo "[bct] Done. Open MATLAB and run: examples/bct_cwt_filter_demo.m"

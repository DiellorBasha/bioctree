function [annots] = in_fs_read_annotation(fname)

% in_fs_read_annotation - reads a binary annotation file into a vector
%
% This function is based on freesurfer_read_annotation from the bioelectromagnetism 
% toolbox (https://eeg.sourceforge.net/bioelectromagnetism.html)
% Original code by Darren L. Weber and contributors.
%
% [annots] = in_fs_read_annotation(fname)
% 
% See also in_fs_read_surf, in_fs_read_curv,
%          in_fs_read_wfile
%
...
ver = '$Revision: 1.2 $';
fprintf('IN_FS_READ_ANNOTATION [v %s]\n',ver(11:15));

function [vertices, faces] = in_fs_read_surf(fname)

% in_fs_read_surf - FreeSurfer I/O function to read a surface file
% 
% This function is based on freesurfer_read_surf from the bioelectromagnetism 
% toolbox (https://eeg.sourceforge.net/bioelectromagnetism.html)
% Original code by Darren L. Weber and contributors.
%
% [vertices, faces] = in_fs_read_surf(fname)
% 
...
%
% See also in_fs_write_surf, in_fs_read_curv,
%          in_fs_read_wfile
%

% $Revision: 1.6 $ $Date: 2005/08/25 23:14:06 $
...
ver = '$Revision: 1.6 $ $Date: 2005/08/25 23:14:06 $';
fprintf('FREESURFER_READ_SURF [v %s]\n',ver(11:15));

if(nargin < 1)
    help in_fs_read_surf;
    return;
end

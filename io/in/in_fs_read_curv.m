function [curv, fnum] = in_fs_read_curv(fname)

% in_fs_read_curv - FreeSurfer I/O function to read a curvature file
%
% This function is based on freesurfer_read_curv from the bioelectromagnetism 
% toolbox (https://eeg.sourceforge.net/bioelectromagnetism.html)
% Original code by Darren L. Weber and contributors.
%
% [curv, fnum] = in_fs_read_curv(fname)
% 
...
% 
% See also in_fs_write_curv, in_fs_read_surf, in_fs_read_wfile
...
ver = '$Revision: 1.2 $ $Date: 2005/05/18 23:07:42 $';

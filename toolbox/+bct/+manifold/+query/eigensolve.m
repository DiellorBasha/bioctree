...
%
% Syntax:
%   E = bct.manifold.query.eigensolve(G, k)
%
% Inputs:
%   G - bct.manifold.Graph object
...
%
% See also: bct.manifold.Graph, bct.Eigenpairs, bct.eigenpairs.fromGraph

arguments
    G (1,1) bct.manifold.Graph

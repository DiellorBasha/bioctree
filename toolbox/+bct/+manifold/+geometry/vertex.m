...
%     .normals.value        - [Nv×3] Vertex normal vectors (unit, area-weighted)
%     .normals.attributes   - Dataset metadata
%     .tangent1.value       - [Nv×3] First tangent vectors (unit, orthogonal to normals)
%     .tangent1.attributes  - Dataset metadata
%     .tangent2.value       - [Nv×3] Second tangent vectors (unit, orthogonal to normals and tangent1)
...
%   by calling bct.manifold.geometry.vertex.frame() and angleDefect().
%
...
%   
%   % Access datasets
%   normals = vg.normals.value;
%   tangent1 = vg.tangent1.value;
%   tangent2 = vg.tangent2.value;
%   
...
[angleDefectHeader, angleDefect] = ...
    bct.manifold.geometry.vertex.angleDefect(mesh);
...
out.normals.attributes = struct(...
    ...
    'description', 'Unit normal vectors at each vertex (area-weighted)', ...
    'shape', [nV, 3], ...
    'dtype', 'double', ...
    'units', '1', ...
    'support', 'vertex', ...
    'normalization', 'unit', ...
    'computedBy', 'bct.manifold.geometry.vertex.frame');
...
out.tangent1.attributes = struct(...
    ...
    'description', 'First tangent vectors (unit, orthogonal to normals)', ...
    'shape', [nV, 3], ...
    'dtype', 'double', ...
    'units', '1', ...
    'support', 'vertex', ...
...
out.tangent2.attributes = struct(...
    ...
    'description', 'Second tangent vectors (unit, orthogonal to normals and tangent1)', ...
    'shape', [nV, 3], ...
    'dtype', 'double', ...
    'units', '1', ...
    'support', 'vertex', ...
...
out.angleDefect.attributes = struct(...
    ...
    'computedBy', 'bct.manifold.geometry.vertex.angleDefect');

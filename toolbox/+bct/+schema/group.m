...
spec.fields.schema = struct(...
    'required', true, ...
    'allowedClasses', ["string", "char"], ...
    'description', 'Schema identifier with version (e.g., "bct.manifold.geometry@1.0.0")', ...
    'pattern', '^[\w.]+@\d+\.\d+\.\d+$', ...  % package@major.minor.patch
    'examples', ["bct.manifold.geometry@1.0.0", "bct.manifold.operator@1.0.0", "bct.manifold.eigen@1.0.0"], ...
    'normalize', @(x) string(x));
...
spec.fields.package = struct(...
    ...
    'pattern', '^[\w.]+$', ...  % Valid MATLAB package path

...
%   N = bct.geometry.normals(M, Type)
%   N = bct.geometry.normals(V, F)
%   N = bct.geometry.normals(V, F, Type)
%
% Inputs:
...
%   M = bct.Manifold(V, F);
%   VN = bct.geometry.normals(M);
%
%   % Face normals from Manifold object
%   FN = bct.geometry.normals(M, 'Face');
%
%   % Vertex normals from V, F directly
%   VN = bct.geometry.normals(V, F);
%
%   % Face normals from V, F directly
%   FN = bct.geometry.normals(V, F, 'Face');
%
